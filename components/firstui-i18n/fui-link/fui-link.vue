<template>
	<!--本文件由FirstUI授权予马*健（会员ID： 3  156，身份证尾号：  01  043X）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
	...
	<!-- #ifndef APP-NVUE -->
	<text v-else class="fui-link__text"
		:class="{'fui-link__underline':underline,'fui-link__defcolor':!color,'fui-link__active':highlight}"
		...
		methods: {
			...
			openURL() {
				...
				uni.setClipboardData({
					...
					success: () => {
						uni.showToast({
							title: this.copyTips || this.tipTextI18n,
							icon: 'none'
						});
					}
				});
