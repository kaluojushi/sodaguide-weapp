<template>
	<!--本文件由FirstUI授权予马*健（会员ID：3 15  6，身份证尾号： 0 1  043X）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
	...
	export default {
		...
		methods: {
			...
			drawComplete(callback) {
				const tips = this.tips || this.tipsTextI18n;
				if (!this.autograph && tips && tips !== true && tips !== 'true') {
					uni.showToast({
						title: tips,
						icon: 'none'
					});
