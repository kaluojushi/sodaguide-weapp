<template>
	<!--本文件由FirstUI授权予马*健（会员ID：  315 6，身份证尾号：  0104  3X）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
				...
				<view class="fui-dk__button-wrap">
					<view class="fui-dk__button"
						...
						<text class="fui-dk__button-text"
							:style="{color:color,fontSize:size+'rpx',fontWeight:fontWeight}">{{text || confirmTextI18n}}</text>
...
<script>
	...
	export default {
		...
		computed: {
			...
			confirmTextI18n() {
				return t("fui-digital-keyboard.confirm")
			}
		},
		data() {
			return {
